...
export declare type TYeelightParams = (string | number)[];
export declare type YeelightPowerState = 'on' | 'off';
export declare type YeelightEffect = 'smooth' | 'sudden';
export declare enum YeelightDeviceModelEnum {
    MONO = "mono",
    COLOR = "color",
    STRIPE = "stripe",
    CEILING = "ceiling",
...
export declare enum YeelightSupportedMethodsEnum {
    toggle = "toggle",
...
export declare enum YeelightColorModeEnum {
    RGB = 1,
    COLOR_TEMPERATURE = 2,
    HSV = 3
}
export declare enum YeelightSupportedPropertiesEnum {
    /**
...
export declare enum YeelightMethodStatusEnum {
    /**
